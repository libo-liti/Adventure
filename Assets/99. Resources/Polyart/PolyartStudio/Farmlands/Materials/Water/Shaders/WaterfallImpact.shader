	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_Voronoi = input.ase_texcoord6.xy * _Voronoi_ST.xy + _Voronoi_ST.zw;
				float mulTime5 = _TimeParameters.x * _VoronoiSpeed;
				float2 appendResult6 = (float2(0.0 , mulTime5));
				float2 uv_ClouNoise = input.ase_texcoord6.xy * _ClouNoise_ST.xy + _ClouNoise_ST.zw;
				float mulTime21 = _TimeParameters.x * _DistortionSpeed;
				...
				float2 texCoord35 = input.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = _Color0.rgb;
				float Alpha = step( _VoronoiStep , ( tex2D( _Voronoi, ( uv_Voronoi + appendResult6 + ( ( appendResult24 - float2( 0.5,0.5 ) ) * _DistortionIntensity ) ) ).g * pow( saturate( ( texCoord35.y * _LengthMul ) ) , _LengthPow ) * pow( ( 1.0 - abs( ( ( texCoord35.x - 0.5 ) * 2.0 ) ) ) , _WidthPow ) ) );
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_Voronoi = input.ase_texcoord3.xy * _Voronoi_ST.xy + _Voronoi_ST.zw;
				float mulTime5 = _TimeParameters.x * _VoronoiSpeed;
				float2 appendResult6 = (float2(0.0 , mulTime5));
				float2 uv_ClouNoise = input.ase_texcoord3.xy * _ClouNoise_ST.xy + _ClouNoise_ST.zw;
				float mulTime21 = _TimeParameters.x * _DistortionSpeed;
				float2 appendResult22 = (float2(0.0 , mulTime21));
				float4 tex2DNode17 = tex2D( _ClouNoise, ( uv_ClouNoise + appendResult22 ) );
				float2 appendResult24 = (float2(tex2DNode17.r , tex2DNode17.g));
				float2 texCoord35 = input.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				float2 uv_Voronoi = input.ase_texcoord.xy * _Voronoi_ST.xy + _Voronoi_ST.zw;
				float mulTime5 = _TimeParameters.x * _VoronoiSpeed;
				float2 appendResult6 = (float2(0.0 , mulTime5));
				float2 uv_ClouNoise = input.ase_texcoord.xy * _ClouNoise_ST.xy + _ClouNoise_ST.zw;
				float mulTime21 = _TimeParameters.x * _DistortionSpeed;
				float2 appendResult22 = (float2(0.0 , mulTime21));
				float4 tex2DNode17 = tex2D( _ClouNoise, ( uv_ClouNoise + appendResult22 ) );
				float2 appendResult24 = (float2(tex2DNode17.r , tex2DNode17.g));
				...
				surfaceDescription.Alpha = step( _VoronoiStep , ( tex2D( _Voronoi, ( uv_Voronoi + appendResult6 + ( ( appendResult24 - float2( 0.5,0.5 ) ) * _DistortionIntensity ) ) ).g * pow( saturate( ( texCoord35.y * _LengthMul ) ) , _LengthPow ) * pow( ( 1.0 - abs( ( ( texCoord35.x - 0.5 ) * 2.0 ) ) ) , _WidthPow ) ) );
...
/*ASEBEGIN
Version=19801
Node;AmplifyShaderEditor.RangedFloatNode;23;-2496,576;Inherit;False;Property;_DistortionSpeed;Distortion Speed;8;0;Create;True;0;0;0;False;0;False;0.1;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;21;-2288,592;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;18;-2384,288;Inherit;True;Property;_ClouNoise;Clou Noise;6;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;2;-1328,-16;Inherit;True;Property;_Voronoi;Voronoi;1;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;26;-1504,480;Inherit;False;Property;_DistortionIntensity;Distortion Intensity;7;0;Create;True;0;0;0;False;0;False;0.04;0.04;0;0.2;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;29;-624,688;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;38;-1216,560;Inherit;False;Property;_LengthMul;Length Mul;5;0;Create;True;0;0;0;False;0;False;1.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-368,768;Inherit;False;Property;_WidthPow;Width Pow;9;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-912,592;Inherit;False;Property;_LengthPow;Length Pow;4;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;10;-544,512;Inherit;False;Property;_VoronoiStep;Voronoi Step;2;0;Create;True;0;0;0;False;0;False;0.5;0;0;0.5;0;1;FLOAT;0
...
WireConnection;51;2;12;0
WireConnection;51;3;9;0
ASEEND*/
//CHKSM=174054CDB886F61946868E8B75B16B96BF7AF1B5