...
Shader "Foam"
{
	Properties
	{
		...
		_WPOIntensity("WPO Intensity", Float) = 10
		_Color0("Color 0", Color) = (1,1,1,0)
		_Color1("Color 1", Color) = (0.256675,0.4971698,0.5283019,0)
		_WPO2Intensity("WPO 2 Intensity", Float) = 10
		_WPOScale("WPO Scale", Float) = 1
		_WPOSpeed2("WPO Speed 2", Float) = -1
		_WPO1Speed("WPO 1 Speed", Float) = -1
		_WPOSpeed("WPO Speed", Float) = -1
		_WPO2Speed("WPO 2 Speed", Float) = -1
		_WPO2PositionMultiplier("WPO 2Position Multiplier", Vector) = (1,1,1,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Color0;
			float4 _Texture0_ST;
			float3 _WPO2PositionMultiplier;
			float _WPOSpeed;
			float _WPOSpeed2;
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float mulTime16 = _TimeParameters.x * _WPOSpeed;
				float3 appendResult15 = (float3(ase_positionWS.x , ( ase_positionWS.y + mulTime16 ) , ase_positionWS.z));
				float simplePerlin3D10 = snoise( appendResult15*_WPOScale );
				simplePerlin3D10 = simplePerlin3D10*0.5 + 0.5;
				float mulTime25 = _TimeParameters.x * _WPO2Speed;
				float3 appendResult27 = (float3(0.0 , mulTime25 , 0.0));
				float simplePerlin3D23 = snoise( ( ( ase_positionWS * _WPO2PositionMultiplier ) + appendResult27 ) );
				simplePerlin3D23 = simplePerlin3D23*0.5 + 0.5;
				float3 temp_output_66_0 = ( ( ( ( simplePerlin3D10 / _WPOIntensity ) * input.normalOS ) + ( input.normalOS * ( ( simplePerlin3D23 - 0.5 ) / _WPO2Intensity ) ) ) + input.positionOS.xyz );
				float3 Pos67 = temp_output_66_0;
				
				float3 objectSpaceLightDir = mul( GetWorldToObjectMatrix(), _MainLightPosition ).xyz;
				output.ase_texcoord6.xyz = objectSpaceLightDir;
						 ...
						 ) : SV_Target
			{
				...
				float3 objectSpaceLightDir = input.ase_texcoord6.xyz;
				float2 uv_Texture0 = input.ase_texcoord7.xy * _Texture0_ST.xy + _Texture0_ST.zw;
				float mulTime157 = _TimeParameters.x * _WPO1Speed;
				...
				float mulTime163 = _TimeParameters.x * _WPO1Speed;
				float2 appendResult165 = (float2(0.0 , mulTime163));
				float2 appendResult168 = (float2(0.0169 , 0.0));
				float mulTime174 = _TimeParameters.x * _WPO1Speed;
				...
				float2 uv_Texture1 = input.ase_texcoord7.xy * _Texture1_ST.xy + _Texture1_ST.zw;
				float mulTime203 = _TimeParameters.x * _WPOSpeed2;
				...
				float mulTime200 = _TimeParameters.x * _WPOSpeed2;
				float2 appendResult206 = (float2(0.0 , mulTime200));
				float2 appendResult204 = (float2(0.0169 , 0.0));
				float mulTime201 = _TimeParameters.x * _WPOSpeed2;
				...
				float3 tangentToWorldDir233 = mul( ase_tangentToWorldFast, BlendNormal( lerpResult181 , lerpResult197 ) );
				float3 normalizeResult232 = normalize( tangentToWorldDir233 );
				float dotResult34 = dot( -objectSpaceLightDir , normalizeResult232 );
...
/*ASEBEGIN
Version=19801
Node;AmplifyShaderEditor.RangedFloatNode;24;-6112,1936;Inherit;False;Property;_WPO2Speed;WPO 2 Speed;10;0;Create;True;0;0;0;False;0;False;-1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;25;-5936,1936;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;21;-6384,1744;Inherit;False;Property;_WPO2PositionMultiplier;WPO 2Position Multiplier;12;0;Create;True;0;0;0;False;0;False;1,1,1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldPosInputsNode;12;-6672,1392;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;17;-6352,1520;Inherit;False;Property;_WPOSpeed;WPO Speed;9;0;Create;True;0;0;0;False;0;False;-1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;13;-5888,1584;Inherit;False;Property;_WPOScale;WPO Scale;6;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;20;-5504,1920;Inherit;False;Property;_WPO2Intensity;WPO 2 Intensity;5;0;Create;True;0;0;0;False;0;False;10;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;159;-4128,-1376;Inherit;False;Property;_WPO1Speed;WPO 1 Speed;8;0;Create;True;0;0;0;False;0;False;-1;-0.48;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;198;-4176,64;Inherit;False;Property;_WPOSpeed2;WPO Speed 2;7;0;Create;True;0;0;0;False;0;False;-1;-0.18;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;154;-4096,-1664;Inherit;True;Property;_Texture0;Texture 0;18;0;Create;True;0;0;0;False;0;False;None;f40728e0bbda94a4ab38de34275e31e9;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;199;-4144,-224;Inherit;True;Property;_Texture1;Texture 1;19;0;Create;True;0;0;0;False;0;False;None;f40728e0bbda94a4ab38de34275e31e9;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SamplerNode;3;-3472,-1648;Inherit;True;Property;_Noise1;Noise1;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;217;-3520,-208;Inherit;True;Property;_Noise2;Noise1;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;228;-2000,432;Inherit;False;Property;_NormalStrength1;Normal Strength;21;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.NormalizeNode;184;-1952,-1152;Inherit;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;182;-2016,-1056;Inherit;False;Property;_NormalStrength;Normal Strength;20;0;Create;True;0;0;0;False;0;False;1;5.34;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;36;-784,-512;Inherit;False;Property;_LightDir;Light Dir;14;0;Create;True;0;0;0;False;0;False;0;0.598;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;37;-800,-368;Inherit;False;Property;_LightBlending;Light Blending;16;0;Create;True;0;0;0;False;0;False;0.1;0.02;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;43;-344.6542,-219.0604;Inherit;False;Property;_VerticalMask;Vertical Mask;15;0;Create;True;0;0;0;False;0;False;0;0.24;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;2;-48,-1008;Inherit;False;Property;_Color0;Color 0;2;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;48;-48,-800;Inherit;False;Property;_Color1;Color 1;4;0;Create;True;0;0;0;False;0;False;0.256675,0.4971698,0.5283019,0;0.6944642,0.9202456,0.9622641,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;245;-3216,-320;Inherit;False;Property;_WPO2SubractValue;WPO 2 Subract Value;22;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;246;-3472,-1456;Inherit;False;Property;_WPO1SubractValue;WPO 1 Subract Value;23;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.NormalVertexDataNode;224;-3024,80;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;229;-2992,-48;Inherit;False;Property;_WPO2Intensity1;WPO 2 Intensity;3;0;Create;True;0;0;0;False;0;False;0.0174;0.98;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;83;-6320,2576;Inherit;False;Property;_WPO2PositionMultiplier1;WPO 2Position Multiplier;13;0;Create;True;0;0;0;False;0;False;1,1,1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.Vector3Node;105;-6288,3232;Inherit;False;Property;_WPO2PositionMultiplier2;WPO 2Position Multiplier;11;0;Create;True;0;0;0;False;0;False;1,1,1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;77;-7264,2368;Inherit;False;Property;_DeviationOffset;Deviation Offset;17;0;Create;True;0;0;0;False;0;False;0.01;0;0;0;0;1;FLOAT;0
...
WireConnection;249;2;47;0
WireConnection;249;5;68;0
ASEEND*/
//CHKSM=885008222C092405DDE7154F2B43AABB9EFB6384